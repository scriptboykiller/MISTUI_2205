 ...
 */
package com.mitsui.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MitsuiFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MitsuiFulfilmentProcessConstants.PARENT_PROCESS);
