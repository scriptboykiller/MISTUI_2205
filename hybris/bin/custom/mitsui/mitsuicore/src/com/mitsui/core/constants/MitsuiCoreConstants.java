 ...
 */
package com.mitsui.core.constants;

/**
 * Global class for all MitsuiCore constants. You can add global constants for your extension into this class.
 */
public final class MitsuiCoreConstants extends GeneratedMitsuiCoreConstants
{
	public static final String EXTENSIONNAME = "mitsuicore";


	private MitsuiCoreConstants()
	{
		//empty
	}
