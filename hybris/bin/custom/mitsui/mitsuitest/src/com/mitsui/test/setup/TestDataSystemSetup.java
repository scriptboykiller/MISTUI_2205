...
import com.mitsui.test.constants.MitsuiTestConstants;
import com.mitsui.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MitsuiTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mitsuitest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mitsuitest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mitsuitest/import/cstickets.impex");
			...
			importImpexFile(context, "/mitsuitest/import/csquotes.impex");
		}
	}
}
